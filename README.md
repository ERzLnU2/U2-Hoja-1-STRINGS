...
![s](https://user-images.githubusercontent.com/80227002/194874594-cb7e10f2-d8b8-4b2c-a072-c47b979540b6.png)
 ...
 */
 ...
 //System.out.print(result1=nombre.concat(apellido)); // CONCATena las cadenas
 
 String result2=(result1.concat(segundoApellido2));
 System.out.print(result2=result1.concat(segundoApellido2));
 ...
 */ 
  ...
  // o concatenar todas: 
   String newvocalesALL = vocales.replace('a', 'o').replace('e', 'o').replace('i', 'o').replace('u', 'o');
  // ***** .REPLACE cada vez reeemplaza
...
*/
   ...
   System.out.println("\nLa longitud de la cadena ciclo es: "+cadena.length()/2);
  // teclado.nextLine()...........
